...
public interface UserAchivementRepository extends JpaRepository<UserAchivement, Long> {
    ...
    /** Query xương sống: mọi thành tựu đã mở khoá của 1 user (cả per-habit lẫn account). */
    ...
    /** Dedup thành tựu account-level (habit_id NULL) — bù cho unique constraint không bắt NULL. */
